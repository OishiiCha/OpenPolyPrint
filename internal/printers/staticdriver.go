...
func (d *StaticDriver) PausePrint(ctx context.Context) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// StopPrint returns an error for the static driver.
func (d *StaticDriver) StopPrint(ctx context.Context) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// Home returns an error for the static driver.
func (d *StaticDriver) Home(ctx context.Context) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// Preheat returns an error for the static driver.
func (d *StaticDriver) Preheat(ctx context.Context, nozzle, bed float64) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// Cooldown returns an error for the static driver.
func (d *StaticDriver) Cooldown(ctx context.Context) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// AutoLevel returns an error for the static driver.
func (d *StaticDriver) AutoLevel(ctx context.Context) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }

// SendGCode returns an error for the static driver.
func (d *StaticDriver) SendGCode(ctx context.Context, command string) error { return fmt.Errorf("not implemented for %s", d.cfg.Type) }
