...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    longDesc: 'PrusaSlicer can upload G-code directly to OpenPolyPrint using the OctoPrint protocol. In PrusaSlicer: Settings → Physical Printers → Add. Set the API URL to your OpenPolyPrint address (e.g. http://openpolyprint:8080). Leave the API key blank. Uploads go to the printer selected in Settings → Slicer upload target.',
  ...
  },
  {
    ...
    color: '#ffc107',
    description: 'Direct upload via OctoPrint API',
    longDesc: 'OrcaSlicer supports direct upload to OpenPolyPrint via the OctoPrint protocol. In OrcaSlicer: Settings → Physical Printers → Add. Set the API URL to your OpenPolyPrint address (e.g. http://openpolyprint:8080). Leave the API key blank. Uploads go to the printer selected in Settings → Slicer upload target. For per-printer routing, use http://openpolyprint:8080/api/files/{printer_name}/local as the upload path.',
