// Package pi provides Raspberry Pi GPIO control and DHT22 filament-sensor support.
package pi

// FilamentSensor represents a single DHT22 sensor in a filament storage box.
...
type FilamentSensor struct {
	...
	GPIOPin      int    `json:"gpioPin"`      // BCM pin for DHT22 data line
...
// and filament box DHT22 sensors.
